package com.loopsopenapispec.api.resources.contacts.delete.params;
...
public final class CreateRequest {
    private final ContactDeleteRequest data;

    private CreateRequest(
        ContactDeleteRequest data
    ) {
        this.data = data;
    }
    ...
    @JsonProperty("data")
    @JsonInclude(JsonInclude.Include.NON_ABSENT)
    public ContactDeleteRequest getData() {
        return data;
    }
    ...
    public static final class Builder {
        private ContactDeleteRequest data = null;
        ...
        @JsonSetter("data")
        public Builder data(ContactDeleteRequest data) {
            if (data == null) {
